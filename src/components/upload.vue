  ...
  <q-page class="q-pt-md">
    ...
    <div class="row full-width">
      <div class="col-xs-12 col-sm-7 offset-sm-2 col-md-6 offset-md-3">
        <q-card class="q-mx-xs my-card q-pa-sm q-mt-md">
          <q-card-section>
            <div class="text-h3 text-center" style="font-size: 4vw">
              TO DO LIST
            </div>
          </q-card-section>
...
export default {
  setup() {
    ...
    function addItem() {
      ...
      //   const db = getDatabase();
      //   try {
      //     const x = todoLists.value.length
      //   push(ref(db, 'user/' + email.value), {x:  [todoTask.value]});
      //   } catch (error) {
      //     console.log(error)
      //   }
      // }
